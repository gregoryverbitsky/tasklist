...
import de.demo.tasklist.web.security.JwtTokenFilter;
import de.demo.tasklist.web.security.JwtTokenProvider;
import de.demo.tasklist.web.security.expression.CustomSecurityExceptionHandler;
...
public class ApplicationConfig {
    ...
    private static final String[] WHITE_LIST_URLS = {"/api/v1/auth/**", "/swagger-ui/**", "/v3/api-docs/**"};
    ...
    public OpenAPI openAPI() {
        return new OpenAPI().addSecurityItem(new SecurityRequirement().addList("bearerAuth"))
                ...
                .info(new Info().title("Task list API").description("Demo Spring Boot application").version("1.0"));
    }
    ...
    public SecurityFilterChain filterChain(final HttpSecurity httpSecurity) {
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .cors(AbstractHttpConfigurer::disable).httpBasic(AbstractHttpConfigurer::disable)
                .sessionManagement(
                ...
                .authorizeHttpRequests(configurer -> configurer.requestMatchers(WHITE_LIST_URLS).permitAll()
